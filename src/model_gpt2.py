...
class MultiOutput(ModelOutput):
    ...
    rec_rep: Optional[torch.FloatTensor] = None
...
class PromptGPT2forCRS(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        rec_loss, rec_logits, rec_rep = None, None, None
        if rec:
            ...
            rec_rep = hidden_states[range(batch_size), sequence_lengths]  # (bs, hidden_size)
            rec_logits = rec_rep @ entity_embeds.T  # (bs, n_entity)
